...
SC_SRCS      = ../simulation/sc_main16.cpp ../simulation/sc_counter16_TB.cpp
SC_TOP_H     = ../simulation/sc_counter16_TB.h ./counter16.h
...
all :
	@echo 'Makefile for counter16 Co-Emulation: Verilog RTL(*) under SystemC Testbench'
	@echo ''
	@echo '    make build'
...
$(TARGET_DIR)/$(TARGET) : $(VERILOG_SRCS) $(SC_SRCS) $(SC_TOP_H)
	$(VERILATOR) --sc -Wall --top-module $(TOP_MODULE) --exe --build \
		-CFLAGS $(CFLAGS) -CFLAGS $(CFLAGS1) -DENT_ENP_CONTROL \
		-CFLAGS -I../../emulation \
