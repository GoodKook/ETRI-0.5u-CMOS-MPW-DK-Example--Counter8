...
SC_SRCS      = sc_main8.cpp sc_counter8_TB.cpp
SC_TOP_H     = sc_counter8_TB.h
VERILATOR    = verilator
CFLAGS       = -std=c++17
#CFLAGS1      = -g
...
all :
	@echo 'Makefile for counter8 Co-Simulation: Verilog RTL(*) under SystemC Testbench'
	@echo ''
	@echo '    make build'
	@echo '        Builds executable of "counter8" with Verilated RTL and SystemC TB'
	@echo ''
	@echo '    make run'
